<div class="col-sm-2">
    ...
    <select class="form-select mb-3 filter_mouza" name="mouza" id="filter_mouza_rs">
...
<div class="col-sm-2">
    <div class="form-group">
        ...
        <select class="sa_livesearch w-100 form-select mb-3 parent_sa" name="parent_dag" data-width="100%">
        </select>
    </div>
</div><!-- Col -->